...
async function createStudentByInvite(coachChatId, firstName, lastName) {
...
module.exports = { getByChatId, getStudentsByCoach, getCities, createUser, parseBirthDate, calculateAge, updateField, updateMeasurements, activateInvite, createStudentByInvite };
