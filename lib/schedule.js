...
async function showCoachMyScheduleMenu(chatId) {
  ...
  const keyboard = [
    [{ text: '📆 Календар', callback_data: CONSTANTS.CALLBACKS.SCH_CALENDAR }],
    [{ text: '7 днів - всі слоти', callback_data: CONSTANTS.CALLBACKS.SCH_7_ALL }],
    [{ text: '7 днів - вільні слоти', callback_data: CONSTANTS.CALLBACKS.SCH_7_AVAILABLE }],
    [{ text: '7 днів - зайняті слоти', callback_data: CONSTANTS.CALLBACKS.SCH_7_BOOKED }],
    [{ text: '7 днів - зарезервовані слоти', callback_data: CONSTANTS.CALLBACKS.SCH_7_REQUESTED }],
    [{ text: '7 днів - резерв', callback_data: CONSTANTS.CALLBACKS.SCH_7_RESERVED }],
