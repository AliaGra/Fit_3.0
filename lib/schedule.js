...
async function showCoachScheduleMenu(chatId) {
  ...
  const keyboard = [
    ...
    [{ text: '🕒 Слоти — праця з ними', callback_data: CONSTANTS.CALLBACKS.SCH_MY_SLOTS }],
  ...
  const workIntro =
    ...
    '2) Створи вільні слоти для запису учнів на тренування через «Слоти — праця з ними» ➡️ «📆 Створити слоти».\n\n';
  ...
  const bookingHint =
    ...
    '2) «👥 Мої учні» ➡️ «Вибрати учня» ➡️ «📅 Записати».';
