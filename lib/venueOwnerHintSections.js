...
const VENUE_OWNER_COACHES_HINTS = Object.freeze({
  ...
  steps: [
    ...
    },
    {
      ...
      body:
        '2. **Показати на картці** — тренер з’являється на публічній картці закладу для учнів і в пошуку.\n' +
    ...
    },
    {
      ...
      body:
        '4. **Відв’язати** — тренер більше не вказує цей заклад у «Де треную» для нових учнів на картці.\n' +
...
const VENUE_OWNER_LIMITS_HINTS = Object.freeze({
  ...
  steps: [
    {
      id: 1,
      shortLabel: 'Без учнів і планів',
      body:
        '1. Власник закладу **не** веде учнів, не складає плани тренувань і не проводить персональні тренування в боті.\n' +
    ...
    },
    {
      ...
      body:
        '2. **Розклад персональних** тренувань і запис учнів до тренера — у кабінеті тренера, не власника.\n' +
