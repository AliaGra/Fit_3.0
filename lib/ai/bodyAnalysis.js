...
function buildBodyStatus(user, measurements, scenario) {
  ...
  const bodyStatus = {
    ...
    weightKg,
    waistCm,
    hipCm: measurements.hip != null ? measurements.hip : user.hip != null ? user.hip : null,
    glutesCm: measurements.glutes != null ? measurements.glutes : user.glutes != null ? user.glutes : null,
