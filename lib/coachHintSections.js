  ...
  steps: [
    {
      ...
      body:
        ...
        'Ціна за тип — у «Вартість тренувань»: персональна (за 1 учня), спліт (загальна сума за 2, ділиться на двох), тріо (загальна за 3, ділиться на трьох).'
    },
    {
      id: 2,
  ...
  steps: [
    ...
    },
    {
      ...
      body:
        ...
        'Спліт і тріо: у тарифі вказується загальна сума за 2 або 3 учні; у звіт доходу з кожного учня потрапляє частка (÷2 або ÷3).'
    }
  ]
});
