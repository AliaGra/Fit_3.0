...
async function showHintsMenu(chatId) {
  ...
  const menuText =
    '💡 **Підказки**\n\n' +
    '**Цифри в дужках** біля кожного розділу — скільки пунктів уже виконано і скільки їх загалом.\n' +
    'Наприклад, **3/9** означає: виконано 3, залишилось ще 6.\n' +
...
function appendSectionNavButtons(keyboard, sectionKey, id) {
  if (sectionKey === 'plan') {
    if (id === 1) {
      keyboard.push([{ text: '📋 Список учнів', callback_data: CONSTANTS.CALLBACKS.HINTS_PLAN_STUDENTS_LIST }]);
