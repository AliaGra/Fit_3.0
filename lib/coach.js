...
function buildCoachMeasurementsPickerKeyboard(studentChatId) {
  ...
  return [
    [{ text: '⚖️ Вага', callback_data: p + ':weight:' + studentChatId }, { text: '⭕ Талія', callback_data: p + ':waist:' + studentChatId }],
    [{ text: '⭕ Стегно', callback_data: p + ':hip:' + studentChatId }, { text: '⭕ Ягодиці', callback_data: p + ':glutes:' + studentChatId }],
    [{ text: '💪 Рука', callback_data: p + ':arm:' + studentChatId }, { text: '🧣 Шия', callback_data: p + ':neck:' + studentChatId }],
    [{ text: '⌚ Запʼястя', callback_data: p + ':wrist:' + studentChatId }, { text: '📐 Плечі', callback_data: p + ':shoulders:' + studentChatId }],
    [{ text: '📐 Груди', callback_data: p + ':chest:' + studentChatId }, { text: '📊 Жир (%)', callback_data: p + ':bodyFatPct:' + studentChatId }],
