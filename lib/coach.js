...
function buildCoachMeasurementsPickerKeyboard(studentChatId) {
  const p = CONSTANTS.CALLBACK_PREFIXES.COACH_STUDENT_MEAS_PICK;
  return [
    [{ text: '📏 Зріст', callback_data: p + ':height:' + studentChatId }, { text: '⚖️ Вага', callback_data: p + ':weight:' + studentChatId }],
    [{ text: '⭕ Талія', callback_data: p + ':waist:' + studentChatId }, { text: '⭕ Стегно', callback_data: p + ':hip:' + studentChatId }],
    [{ text: '⭕ Ягодиці', callback_data: p + ':glutes:' + studentChatId }, { text: '💪 Рука', callback_data: p + ':arm:' + studentChatId }],
    [{ text: '🧣 Шия', callback_data: p + ':neck:' + studentChatId }, { text: '⌚ Запʼястя', callback_data: p + ':wrist:' + studentChatId }],
    [{ text: '📐 Плечі', callback_data: p + ':shoulders:' + studentChatId }, { text: '📐 Груди', callback_data: p + ':chest:' + studentChatId }],
    [{ text: '📊 Жир (%)', callback_data: p + ':bodyFatPct:' + studentChatId }],
...
async function showCoachMeasurementsPicker(chatId, studentChatId, notice = null) {
  ...
  const noticeLine = notice ? (String(notice).trim() + '\n\n') : '';
  const keyboard = buildCoachMeasurementsPickerKeyboard(studentChatId);
