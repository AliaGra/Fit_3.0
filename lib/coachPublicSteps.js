...
const COACH_PUBLIC_STEPS = Object.freeze([
  {
    ...
    body:
      '1. Додай посилання на свій інстаграм-акаунт: 🏠 Головне меню → Мій профіль → Редагувати дані → Instagram'
  },
  {
    id: 2,
    shortLabel: 'Документи про освіту',
    body:
      '2. Завантаж документи про освіту у сфері фітнес-індустрії: 🏠 Головне меню → Мій профіль → Мої документи'
  },
  {
    id: 3,
    shortLabel: 'Де треную',
    body:
      '3. Укажи, в яких фітнес-центрах та студіях ти проводиш тренування: 🏠 Головне меню → Мій профіль → Де треную'
  },
  {
    id: 4,
    shortLabel: 'Розклад робочого тижня',
    body:
      '4. Якщо цього ще не зробив, то налаштуй розклад свого робочого тижня: 🏠 Головне меню → 📅 Розклад → ⚙️ Налаштування розкладу.'
  }
]);
