/**
 * Підказки учня — з тренером (4 розділи) та без тренера / solo (4 розділи).
 * Набір розділів визначається динамічно за наявністю user.coachId.
 */
...
// ─── Секції для учня З ТРЕНЕРОМ ───────────────────────────────────────────────

const SECTIONS_WITH_COACH = Object.freeze([
  {
    key: 'first',
    ...
    steps: [
      {
        ...
        navButtons: [{ text: '✏️ Редагувати дані', callback_data: CONSTANTS.CALLBACKS.PROFILE_EDIT_DATA }],
        body:
      ...
      },
      {
        ...
        navButtons: [{ text: '🎯 Бажані параметри', callback_data: CONSTANTS.CALLBACKS.PROFILE_EDIT_GOALS }],
        body:
      ...
      },
      {
        ...
        navButtons: [{ text: '🖋️ Записатись на тренування', callback_data: CONSTANTS.CALLBACKS.SCH_STUDENT_BOOK }],
        body:
      ...
      },
      {
        ...
        navButtons: [{ text: '📅 Мій розклад', callback_data: CONSTANTS.CALLBACKS.SCH_S_MY_SCHEDULE }],
        body:
      ...
      },
      {
        ...
        navButtons: [{ text: '👨‍🏫 Мій тренер', callback_data: CONSTANTS.CALLBACKS.COACH_MY_COACH_MENU }],
        body:
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        navButtons: [{ text: '🔄 Змінити запис', callback_data: CONSTANTS.CALLBACKS.SCH_S_MY_EDIT }],
        body:
    ...
    steps: [
      {
        ...
        navButtons: [{ text: '🤖 AI-аналітика', callback_data: CONSTANTS.CALLBACKS.AI_ANALYTICS }],
        body:
      ...
      },
      {
        ...
        navButtons: [{ text: '📊 Оновити заміри', callback_data: CONSTANTS.CALLBACKS.PROFILE_UPDATE_MEASUREMENTS }],
        body:
      ...
      },
      {
        ...
        navButtons: [{ text: '💪 Моє тренування', callback_data: CONSTANTS.CALLBACKS.TRAINING_START }],
        body:
    ...
    steps: [
      {
        ...
        navButtons: [{ text: '📊 Історія тренувань', callback_data: CONSTANTS.CALLBACKS.HISTORY_MENU }],
        body:
      ...
      },
      {
        ...
        navButtons: [{ text: '🎫 Абонемент', callback_data: CONSTANTS.CALLBACKS.MENU_SUBSCRIPTION }],
        body:
...
// ─── Секції для СОЛО-учня (без тренера) ──────────────────────────────────────

const SECTIONS_SOLO = Object.freeze([
  {
    key: 'solo_first',
    persistKey: 'studentSoloHintsFirstDone',
    menuLabel: '🚀 В першу чергу',
    headerTitle: '🚀 **В першу чергу**',
    menuCallback: CONSTANTS.CALLBACKS.STUDENT_HINTS_SOLO_FIRST,
    fullTextCallback: CONSTANTS.CALLBACKS.STUDENT_HINTS_SOLO_FIRST_TEXT,
    togglePrefix: CONSTANTS.CALLBACK_PREFIXES.STUD_SF_T,
    viewPrefix: CONSTANTS.CALLBACK_PREFIXES.STUD_SF_V,
    steps: [
      {
        id: 1,
        shortLabel: 'Заповнити профіль',
        ...
        body:
          '1. Заповни свій профіль — поточні фізичні параметри та активність.\n' +
          'Платформа використовує ці дані для AI-аналізу та авто-підбору плану тренувань:\n' +
          '🏠 Головне меню → 👤 Мій профіль → ✏️ Редагувати дані\n' +
          '(зріст, вага, дата народження, рівень активності, ціль тренувань).'
      },
      {
        ...
        body:
          '2. Заповни бажані параметри тіла — скільки важити, обсяги, відсоток жиру.\n' +
          'Ці дані потрібні для AI-аналізу та автоматичного підбору акцентних зон у плані:\n' +
          '🏠 Головне меню → 👤 Мій профіль → 🎯 Бажані параметри.'
      },
      {
        id: 3,
        shortLabel: 'Кількість днів тренувань',
        navButtons: [{ text: '📋 План тренувань', callback_data: CONSTANTS.CALLBACKS.MENU_TRAINING_PLANS }],
        body:
          '3. Вкажи, скільки днів на тиждень плануєш тренуватись — це основа для авто-плану:\n' +
          '🏠 Головне меню → 💪 Тренування → 📋 План тренувань → Кількість днів тренування в тиждень.'
      },
      {
        id: 4,
        shortLabel: 'Оновлювати заміри',
        navButtons: [{ text: '📊 Оновити заміри', callback_data: CONSTANTS.CALLBACKS.PROFILE_UPDATE_MEASUREMENTS }],
        body:
          '4. Оновлюй заміри регулярно (раз на 2–4 тижні) — платформа відстежує прогрес\n' +
          'і AI коригує рекомендації:\n' +
          '🏠 Головне меню → 👤 Мій профіль → 📊 Оновити заміри.'
      }
    ]
  },
  {
    key: 'solo_plan',
    persistKey: 'studentSoloHintsPlanDone',
    menuLabel: '📋 Самостійний план тренувань',
    headerTitle: '📋 **Самостійний план тренувань**',
    menuCallback: CONSTANTS.CALLBACKS.STUDENT_HINTS_SOLO_PLAN,
    fullTextCallback: CONSTANTS.CALLBACKS.STUDENT_HINTS_SOLO_PLAN_TEXT,
    togglePrefix: CONSTANTS.CALLBACK_PREFIXES.STUD_SP_T,
    viewPrefix: CONSTANTS.CALLBACK_PREFIXES.STUD_SP_V,
    steps: [
      {
        id: 1,
        shortLabel: 'Авто-план',
        navButtons: [{ text: '📋 План тренувань', callback_data: CONSTANTS.CALLBACKS.MENU_TRAINING_PLANS }],
        body:
          '1. Авто-план — платформа підбере вправи сама, враховуючи твій профіль, ціль,\n' +
          'акцентні зони та кількість тренувальних днів:\n' +
          '🏠 Головне меню → 💪 Тренування → 📋 План тренувань → ⚙️ Авто-план.\n' +
          'Можна вибрати кількість вправ або довіритись рекомендації AI.'
      },
      {
        id: 2,
        ...
        navButtons: [{ text: '📋 План тренувань', callback_data: CONSTANTS.CALLBACKS.MENU_TRAINING_PLANS }],
        body:
          '2. Ручний план — склади власний план з бібліотеки вправ або зі своїх вправ:\n' +
          '🏠 Головне меню → 💪 Тренування → 📋 План тренувань → ✏️ Створити план вручну.\n' +
          'Додавай вправи, підходи та ваги; платформа зберігає і показує план при тренуванні.'
      },
      {
        id: 3,
        ...
        navButtons: [
          ...
          { text: '⭐ Мої вправи', callback_data: CONSTANTS.CALLBACKS.MY_EX_MENU }
        ],
        body:
          '3. При складанні плану використовуй бібліотеку вправ або додавай свої вправи\n' +
          '(доступні лише тобі):\n' +
  ...
  {
    key: 'solo_ai',
    persistKey: 'studentSoloHintsAiDone',
    menuLabel: '🤖 AI-аналітика',
    headerTitle: '🤖 **AI-аналітика**',
    menuCallback: CONSTANTS.CALLBACKS.STUDENT_HINTS_SOLO_AI,
    fullTextCallback: CONSTANTS.CALLBACKS.STUDENT_HINTS_SOLO_AI_TEXT,
    togglePrefix: CONSTANTS.CALLBACK_PREFIXES.STUD_SAI_T,
    viewPrefix: CONSTANTS.CALLBACK_PREFIXES.STUD_SAI_V,
    steps: [
      {
        id: 1,
        shortLabel: 'AI-аналіз тіла',
        navButtons: [{ text: '🤖 AI-аналітика', callback_data: CONSTANTS.CALLBACKS.AI_ANALYTICS }],
        body:
          '1. Запусти AI-аналіз свого тіла — отримаєш оцінку фізичного стану,\n' +
          'рекомендовані акцентні зони та поради щодо навантаження:\n' +
          '🏠 Головне меню → 🤖 AI-аналітика.\n' +
          'Чим повніше профіль (заміри, активність, ціль) — тим точніший результат.\n' +
          'Оновлюй заміри — аналіз показує динаміку.'
      },
      {
        id: 2,
        shortLabel: 'Знайти тренера',
        navButtons: [{ text: '👨‍🏫 Мій тренер', callback_data: CONSTANTS.CALLBACKS.COACH_MY_COACH_MENU }],
        body:
          '2. Якщо захочеш тренуватись із тренером — знайди його через пошук або введи інвайт-код:\n' +
          '🏠 Головне меню → 💪 Тренування → 👨‍🏫 Мій тренер → Пошук тренера або Ввести інвайт-код.\n' +
          'Після прив\'язки до тренера тобі стануть доступні розклад, запис та індивідуальний план.'
      }
    ]
  },
  {
    key: 'solo_progress',
    persistKey: 'studentSoloHintsProgressDone',
    menuLabel: '📊 Мій прогрес',
    headerTitle: '📊 **Мій прогрес**',
    menuCallback: CONSTANTS.CALLBACKS.STUDENT_HINTS_SOLO_PROGRESS,
    fullTextCallback: CONSTANTS.CALLBACKS.STUDENT_HINTS_SOLO_PROGRESS_TEXT,
    togglePrefix: CONSTANTS.CALLBACK_PREFIXES.STUD_SPRG_T,
    viewPrefix: CONSTANTS.CALLBACK_PREFIXES.STUD_SPRG_V,
    steps: [
      {
        id: 1,
        shortLabel: 'Історія тренувань',
...
// ─── Всі секції (для маршрутизації) ──────────────────────────────────────────

const ALL_SECTIONS = Object.freeze([...SECTIONS_WITH_COACH, ...SECTIONS_SOLO]);

// ─── Допоміжні функції ────────────────────────────────────────────────────────

function isSolo(user) {
  return !user || !user.coachId || String(user.coachId).trim() === '';
}

function getSectionsForUser(user) {
  return isSolo(user) ? SECTIONS_SOLO : SECTIONS_WITH_COACH;
}
...
async function showHintsMenu(chatId) {
  ...
  const doneMaps = await Promise.all(sections.map((section) => getDoneMap(chatId, section)));
  const keyboard = [];
  for (let i = 0; i < sections.length; i++) {
    const section = sections[i];
    keyboard.push([
      {
        text: hintsMenuProgressLabel(section.menuLabel, countDone(doneMaps[i], section), section.steps.length),
        callback_data: section.menuCallback
      }
    ]);
  }
