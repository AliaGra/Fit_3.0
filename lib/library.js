...
async function showExerciseDetail(chatId, exerciseId) {
  ...
  const keyboard = [
    [{ text: '🏷 Моя назва', callback_data: CONSTANTS.CALLBACK_PREFIXES.ALIAS_LIST + ':' + exerciseId }, { text: '➕ Ввести своє найменування', callback_data: CONSTANTS.CALLBACK_PREFIXES.ALIAS_ADD + ':' + exerciseId }],
