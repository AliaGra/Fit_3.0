...
async function showPlanList(chatId, studentChatId) {
  ...
  if (isSelfMode) keyboard.push([{ text: CONSTANTS.EMOJI.HOME + ' До меню Тренування', callback_data: CONSTANTS.CALLBACKS.MENU_TRAINING }]);
...
function getAutoPlanIncompleteProfilePrompt(studentChatId, missing, isSelfMode) {
  ...
  if (isSelfMode) {
    msg =
      ...
      missingStr +
      '.\n\nВідкрий **Мій профіль** → **Редагувати дані** (мета, дата народження) та зони акценту, або створи план вручну.';
