...
**Перенос:** Тренер обирає слот з учнем → [🔄 Перенести] → **календар 21 день** → обирає дату → слоти дня → обирає новий слот. Система відправляє учню запит на підтвердження (старий час → новий час). Учень підтверджує або відхиляє. Після підтвердження/відхилення тренер повертається до **календаря**.
