...
- **Календар тренера** (21 день з «Мій розклад»): легенда кнопок днів — 🟢 сьогодні; 🟡 **неділя** або **відпустка** або **вихідний день за налаштуваннями**; ⬜ немає слотів; число в дужках — зайняті слоти на день. Неділя візуально **жовта** (🟡). У календарі відпустки неділя також **🟡** (не червона).
