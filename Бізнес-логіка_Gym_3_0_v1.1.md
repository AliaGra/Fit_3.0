...
**Оновлення:** 12.02.2026. Розклад: скасування/перенос (4.4.1–4.4.4) реалізовано з двостороннім підтвердженням.
...
| 8 | **Розклад тренувань** | ✅ Реалізовано | Тренер: вікна, підтвердити/відхилити/завершити, записати учня, скасування та перенос (запит учню). Учень: записатись, «Мій розклад», скасування та перенос (запит тренеру). **4.4.1–4.4.4:** скасування/перенос з двостороннім підтвердженням — реалізовано |
