...
**Оновлення:** 13.02.2026. Позначено, що вже реалізовано в боті на Node.js (Supabase + Railway), щоб нічого не пропустити.
...
| 8 | **Розклад тренувань** | ✅ Частково | Тренер: вікна, підтвердити/відхилити/скасувати/завершити, записати учня. Учень: записатись, «Мій розклад». **У бізнес-логіці (4.4.1–4.4.4):** скасування/перенос по просьбі учня чи тренера — завжди з підтвердженням іншої сторони. Ще не реалізовано |
