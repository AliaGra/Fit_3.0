...
**Оновлення:** 21.03.2026 — календар 21 день, перенос через календар, «Хочу перерву», зони акценту авто-перехід, BMI-ліміти по статі/віку, fallback floor ваги, конфіденційність підлітків, fix invite FK-constraint, SCH_CR_OK/NO, 🔵 у календарі учня.  
...
**Крок 3:** Показ календаря (**21 день**, сітка 7×3). Позначення: 🟢 сьогодні, 🔴 неділя, ⬜ день без вільних слотів; 🔵 день де вже є запис учня; біля дати — кількість вільних слотів. Дата без року.
...
**Крок 2:** Система показує учню **календар 21 день** (🔵 = вже є запис) → учень обирає дату → список вільних слотів тренера.
