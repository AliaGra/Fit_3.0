...
| 8 | **Розклад тренувань** | ✅ Реалізовано | Тренер: налаштування шаблону (дні відпочинку, тривалість, робочий день), створення слотів (авто на 7–30 днів), Мій розклад з позначкою «Вільний», підтвердити/відхилити/завершити, записати учня (календар → дата → вільні слоти), скасування та перенос (запит учню). Учень: записатись (календар → дата → вільні слоти), Мій розклад, скасування та перенос (запит тренеру). **Нагадування учням** — endpoint `/cron/reminders` |
