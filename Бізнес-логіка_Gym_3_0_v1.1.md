...
- **Слоти обраного дня** (`showCoachDaySlots`): у **тексті** — рядки для **зайнятих** (BOOKED — учень), **перерви** (RESERVED), **на підтвердженні** (REQUESTED); рядків «Вільний» у тексті **немає**. Далі «Обери слот:» — у **інлайн-кнопках** усі майбутні слоти дня (час без дати); без пагінації.
