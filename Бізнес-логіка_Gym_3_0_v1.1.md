...
**Оновлення:** 11.02.2026. Позначено, що вже реалізовано в боті на Node.js (Supabase + Railway), щоб нічого не пропустити.
...
| 3 | **Мої учні** | ✅ Реалізовано | Список учнів, профіль учня, **Додати учня** (ім'я+прізвище → createStudentByInvite, показ коду). Історія / Записати / Почати тренування — заглушки |
...
| 6 | **Бібліотека вправ** | ⏸ Не чіпаємо | Дані користувач править у Google Таблиці; показ у боті — пізніше |
...
| 8 | **Розклад тренувань** | ✅ Реалізовано | Без Google Calendar: тренер додає вікна в боті (дата+час), «Мій розклад» (підтвердити/відхилити/скасувати/завершити, записати учня), учень — «Записатись на тренування» (вибір слота → REQUESTED), «Мій розклад». Дані в Supabase workout_schedule |
| 9 | **Історія тренувань** | ❌ Не реалізовано | Заглушка |
| 10 | **Звіти тренера** | ❌ Не реалізовано | Заглушка |
