...
| 3 | **Мої учні** | ✅ Реалізовано | Список учнів (coach_id = chatId), профіль учня (перегляд). Додати учня / Історія / Записати / Почати тренування — заглушки |
| 4 | **Тренування учнів** | 🟡 Заглушка | Кнопка веде на повідомлення «модуль переноситься»; вибір учня та лог тренувань — далі |
| 5 | **Інвайт-код («У мене є код»)** | ❌ Не реалізовано | Заглушка в боті |
| 6 | **Бібліотека вправ** | ⏸ Не чіпаємо | Дані користувач править у Google Таблиці; показ у боті — пізніше |
| 7 | **Профіль (перегляд/редагування, заміри)** | ❌ Не реалізовано | Заглушка |
| 8 | **Розклад тренувань** | ❌ Не реалізовано | Заглушка |
