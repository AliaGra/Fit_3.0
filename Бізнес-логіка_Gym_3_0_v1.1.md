...
**Сет (мін. 2 вправи) — потік формування списку, потім тренування:**
```
...
5. Коли в списку уже ≥ 2 вправи — з'являється подвійний вибір: [Додати ще вправу] або [Перейти до тренування]
6. [Перейти до тренування] → введення ваги/повторів по черзі для кожної вправи зі списку
```
Тобто спочатку формується **список вправ**, лише потім — введення даних (як у п. 3.6 Круговий сет).
