...
**Оновлення:** 03.06.2026 — **роль `venue_owner`** (фаза 0, `7c71f39`); **адмін зняття власника без видалення закладу** (`537b296`); **Умови користування** в головному меню (`1207ab4`); **пошук закладів за `city_list`** (`b35ff46`).  
