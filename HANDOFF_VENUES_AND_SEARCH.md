...
- **Фаза 4.3** плану: редагування існуючого закладу в адмін-боті (адреса, теги, повторна геолокація).
...
- **Учень** — показ закладів тренера в картці «Мій тренер» (фаза 6.2 плану).
- **Узгодження** з `TZ_FitnessClubs_FIT3.md` (обладнання клубу / плани) — окреме рішення.
- **`venue_schedule`:** лише схема; документувати формат SQL-імпорту (фаза 8.1).
