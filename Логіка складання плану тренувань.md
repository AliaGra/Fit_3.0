...
PLAN\_EXERCISE:{ex\_id}	Тип 2	Обрати вправу для дня (ручний план) → далі вибір типу виконання
PLAN\_EXERCISE\_ADD:{ex\_id}:SET	Тип 2	Тип виконання: кілька підходів (сети); sets/reps з getSetsRepsRest
PLAN\_EXERCISE\_ADD:{ex\_id}:SINGLE	Тип 2	Тип виконання: одиночне; sets=1, reps=1, rest\_sec=0
...
**Тип виконання вправи при ручному додаванні (п. 10.2):** при додаванні вправи в план вручну тренер обирає тип виконання: **«Кілька підходів (сети)»** (sets/reps з getSetsRepsRest за ціллю і рівнем плану) або **«Одиночне виконання»** (sets=1, reps='1', rest\_sec=0). Реалізація: PLAN\_EXERCISE → показ вибору → PLAN\_EXERCISE\_ADD:exId:SET | SINGLE → insertTrainingPlanExercise.
